...
$arrSpecialMenuItems['newmembers'] = "<div style='margin-left: 1px; margin-right: 18px; margin-top: 5px; margin-bottom: 20px'>";
...
while($row = $result->fetch_assoc()) {
	...
	elseif($newestMemberInfo['profilepic'] == "") {
		$newestMemberInfo['profilepic'] = $MAIN_ROOT."themes/medieval/images/defaultprofile.png";
	}
	
	$menuMemberRankObj->select($newestMemberInfo['rank_id']);
	$arrSpecialMenuItems['newmembers'] .= "<div style='float: left; width: 40px'><img src='".$newestMemberInfo['profilepic']."' style='width: 35px; height: 47px; border: solid black 1px'></div>";
...
$arrSpecialMenuItems['forumactivity'] = "<div style='margin-left: 1px; margin-right:18px; margin-top: 5px; margin-bottom: 20px'>";
$counter = 0;
$postCount = 0;
...
while($row = $result->fetch_assoc()) {
	...
	if($blnShowPost) {
		...
		elseif($forumMemberInfo['avatar'] == "") {
			$forumMemberInfo['avatar'] = $MAIN_ROOT."themes/medieval/images/defaultavatar.png";
		}
