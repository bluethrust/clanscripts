<?php
	...
	$arrCSSInfo = array(
		...
		"form-component-border" => "solid darkgray 1px",
		...
		"box-bg-image" => "url('".$THEME."/images/layout/contentbox/bg.png')",
		...
		"forum-title-bg-image" => "url('".$THEME."/images/gradient.jpg')",
		"forum-title-bg-color" => "none",
		"forum-title-font-color" => "white",
		"forum-title-font-size" => "12px",
		"forum-new-post-bg-color" => "transparent",
		"forum-new-post-bg-image" => "url('".$THEME."/images/layout/contentbox/bg.png')",
		"forum-quote-bg-color" => "transparent",
		"forum-quote-bg-image" => "url('".$THEME."/images/layout/contentbox/bg.png')",
		...
		"sidemenu-forumactivity-width" => "95px",
		...
		"poll-info-label-bg" => "url('".$THEME."/images/layout/contentbox/bg.png')",
		"poll-profilepic-width" => "90px",
		"poll-profilepic-height" => "120px",
		"page-selector-current-page-bg" => "rgba(0,0,0,.65) !important"
	);
