<?php
	...
	$arrCSSInfo = array(
		...
		"form-component-border" => "solid darkred 1px",
		...
		"default-border-color" => "darkred",
		"box-bg-color" => "transparent",
		"box-bg-image" => "url('".$THEME."/images/formdiv-bg.png')",
		...
		"console-category-button-border" => "dotted darkred 1px",
		"console-category-button-bg-color" => "#B22222",
		"console-category-button-hover-bg-color" => "#800000",
		...
		"error-bg-color" => "url('".$THEME."/images/formdiv-bg.png')",
		"error-border" => "dashed darkred 1px",
		...
		"alternate-bg-color" => "url('".$THEME."/images/formdiv-bg.png')",
		"youtube-embed-width" => "560px",
		"youtube-embed-height" => "315px",
		"shoutbox-bg-color" => "transparent",
		"shoutbox-bg-image" => "url('".$THEME."/images/shoutbox-bg.png')",
		...
		"forum-new-post-bg-color" => "url('".$THEME."/images/formdiv-bg.png')",
		"forum-new-post-bg-image" => "none",
		"forum-quote-bg-color" => "url('".$THEME."/images/formdiv-bg.png')",
		...
		"poll-info-label-bg" => "url('".$THEME."/images/formdiv-bg.png')",
