...
$menuSQL = "INSERT INTO `menuitem_custompage` (`menucustompage_id`, `menuitem_id`, `custompage_id`, `prefix`, `linktarget`, `textalign`) VALUES(3, 19, 12, '<b>&middot;</b> ', '', 'left');
...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(3, 0, 'Main Menu', 2, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_MainMenu''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(2, 0, 'Top Players', 3, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_TopPlayers''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(10, 0, 'Forum Activity', 4, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_ForumActivity''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(12, 1, 'Default Login', 1, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_LogIn''>', 2, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(8, 1, 'Default Logged In', 2, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_LoggedIn''>', 1, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(9, 1, 'Shoutbox', 3, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_ChatBoard''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(11, 1, 'Newest Members', 4, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_NewestMembers''>', 0, 0);
...
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(48, 10, 'Forum Activity', 'forumactivity', 0, 0, 0, 1);
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(49, 11, 'Newest Members', 'newestmembers', 0, 0, 0, 1);
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(50, 12, 'Login', 'login', 0, 0, 0, 1);
