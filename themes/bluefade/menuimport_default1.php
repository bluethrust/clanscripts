...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(3, 0, 'Main Menu', 1, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_MainMenu''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(2, 0, 'Top Players', 2, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_TopPlayers''>', 0, 0);
...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(8, 1, 'Default Login', 1, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_LoggedIn''>', 1, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(9, 1, 'Shoutbox', 2, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_ChatBoard''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(11, 1, 'Newest Members', 3, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/transparent.png'' class=''menu_NewestMembers''>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(12, 0, 'Poll', 3, 'customcode', '<img src=''[MAIN_ROOT]themes/bluefade/images/menu/poll.png''>', 0, 1);
