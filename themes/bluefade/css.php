<?php
	...
	$arrCSSInfo = array(
		...
		"forum-quote-bg-image" => "url('".$THEME."/images/formbg.png')",
		...
		"sidemenu-profilepic-div-width" => "34px",
		"sidemenu-profilepic-width" => "30px",
		"sidemenu-profilepic-height" => "40px",
		...
		"page-selector-current-page-bg" => "#181818 !important"
	);
