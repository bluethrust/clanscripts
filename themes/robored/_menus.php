...
while($row = $result->fetch_assoc()) {
	...
	elseif($newestMemberInfo['profilepic'] == "") {
		$newestMemberInfo['profilepic'] = $MAIN_ROOT."themes/robored/images/defaultprofile.png";
	}
...
while($row = $result->fetch_assoc()) {
	...
	if($blnShowPost) {
		...
		elseif($forumMemberInfo['avatar'] == "") {
			$forumMemberInfo['avatar'] = $MAIN_ROOT."themes/robored/images/defaultavatar.png";
		}
		...
		foreach($arrMenuItems as $menuItemID) {
			...
			switch($menuItemInfo['itemtype']) {
				...
				case "shoutbox":
					...
					$mainShoutboxObj->blnMainShoutbox = true;
