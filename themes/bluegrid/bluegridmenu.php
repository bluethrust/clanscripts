<?php
	...
	class BlueGridMenu extends btThemeMenu {
		...
		public function displayMenuCategory($loc="top") {
			...
			if($loc == "top" && $this->intMenuSection != 2) {
				...
				$menuCatCSS = ($this->intMenuSection == 0) ? "menuCatLeft" : "menuCatRight";
				...
				if($menuCatInfo['headertype'] == "image") {
					...
					echo "<div class='menuCatTitle ".$menuCatCSS."'>".$menuCatInfo['headercode']."</div>";
				}
