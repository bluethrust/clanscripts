<?php
	...
	$arrCSSInfo = array(
		...
		"default-border-color" => "#044c9f",
		"box-bg-color" => "rgba(11,11,11,.75)",
		"box-bg-image" => "none",
		...
		"alternate-bg-color" => "rgba(0,0,0,.4)",
		"youtube-embed-width" => "560px",
		"youtube-embed-height" => "315px",
		"shoutbox-bg-color" => "rgba(0,0,0, .25)",
		...
		"forum-new-post-bg-color" => "rgba(4,76,159,.10)",
		"forum-new-post-bg-image" => "none",
		"forum-quote-bg-color" => "rgba(255,255,255,.25)",
		...
		"page-selector-current-page-bg" => "rgba(4,76,159,.75) !important"
	);
