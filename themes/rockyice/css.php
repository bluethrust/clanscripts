<?php
	...
	$arrCSSInfo = array(
		...
		"default-border-color" => "#003b62",
		"box-bg-color" => "rgba(0,0,0,.25)",
		"box-bg-image" => "none",
		...
		"alternate-bg-color" => "rgba(255,255,255,.03)",
		...
		"tournament-bracket-link-hover-color" => "#5cbfff",
