<?php
	...
	$arrCSSInfo = array(
		...
		"console-category-button-border" => "dotted #3b0055 1px",
		"console-category-button-bg-color" => "url('".$THEME."/images/layout/consoleoption-bg.png')",
		"console-category-button-hover-bg-color" => "url('".$THEME."/images/layout/consoleoptionalt-bg.png')",
		"console-category-button-width" => "200px",
		"form-label-width" => "175px",
		"table-title-bg-color" => "transparent",
		"table-title-bg-image" => "url('".$THEME."/images/layout/consoleoptionalt-bg.png')",
		...
		"error-border" => "dashed #3b0055 1px",
		...
		"shoutbox-bg-image" => "url('".$THEME."/formdiv-bg.png')",
		"shoutbox-font-size" => "10px",
		...
		"forum-title-bg-image" => "url('".$THEME."/images/layout/consoleoptionalt-bg.png')",
