<?php
	...
	$arrCSSInfo = array(
		...
		"default-border-color" => "#303233",
		"box-bg-color" => "rgba(255,255,255,.05)",
		"box-bg-image" => "none",
		...
		"error-bg-color" => "rgba(255,255,255,.05)",
		...
		"alternate-bg-color" => "rgba(255,255,255,.05)",
		...
		"tournament-bracket-link-hover-color" => "#a8a8a8",
		...
		"forum-quote-bg-color" => "rgba(255,255,255,.05)",
