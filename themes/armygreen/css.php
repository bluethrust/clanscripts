<?php
	...
	$arrCSSInfo = array(
		...
		"form-component-border" => "solid green 1px",
		...
		"tournament-bracket-link-hover-color" => "#b7ffa9",
		...
		"forum-new-post-bg-color" => "url('".$THEME."/images/forumnewbg.png')",
		...
		"page-selector-current-page-bg" => "green !important"
	);
