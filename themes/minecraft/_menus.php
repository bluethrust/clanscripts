...
$arrSpecialMenuItems['newmembers'] = "<div style='margin-top: 5px; margin-bottom: 20px'>";
...
while($row = $result->fetch_assoc()) {
	...
	elseif($newestMemberInfo['profilepic'] == "") {
		$newestMemberInfo['profilepic'] = $MAIN_ROOT."themes/minecraft/images/defaultprofile.png";
	}
	...
	$arrSpecialMenuItems['newmembers'] .= "<div style='float: left; padding-left: 8px; width: 95px'><div style='font-size: 12px; overflow: hidden; text-overflow: ellipsis; width: 95px'>".$menuMemberObj->getMemberLink()."</div><div class='main' style='width: 95px; overflow: hidden; text-overflow: ellipsis'>".$menuMemberRankObj->get_info_filtered("name")."</div></div>";
...
$arrSpecialMenuItems['forumactivity'] = "<div style='margin-top: 5px; margin-bottom: 20px'>";
$counter = 0;
$postCount = 0;
...
while($row = $result->fetch_assoc()) {
	...
	if($blnShowPost) {
		...
		elseif($forumMemberInfo['avatar'] == "") {
			$forumMemberInfo['avatar'] = $MAIN_ROOT."themes/minecraft/images/defaultavatar.png";
		}
