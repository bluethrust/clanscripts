<?php
	...
	$arrCSSInfo = array(
		...
		"console-category-button-border" => "dotted #624f3b 1px",
		"console-category-button-bg-color" => "#ceac89",
		"console-category-button-hover-bg-color" => "#ad7d4a",
		...
		"error-bg-color" => "url('".$THEME."/images/errordiv.png')",
		"error-border" => "dashed #624f3b 1px",
		"error-bold-color" => "#624f3b",
		"avatar-width" => "50px",
		"avatar-height" => "50px",
		...
		"tournament-bracket-link-color" => "black",
		"tournament-bracket-link-hover-color" => "#647d99",
		...
		"page-selector-current-page-bg" => "rgba(0,0,0,.15) !important"
	);
