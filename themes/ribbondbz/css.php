<?php
	...
	$arrCSSInfo = array(
		...
		"link-color" => "#e69999",
		"link-hover-color" => "#fea7a7",
		"font-family" => "verdana, sans-serif",
		"dialog-font-color" => "white",
		"dialog-font-family" => "verdana, sans-serif",
		"form-component-border" => "solid rgba(112,15,15,.2) 1px",
		...
		"default-border-color" => "rgba(112,15,15,.5)",
		...
		"alternate-bg-color" => "rgba(112,15,15,.05)",
		...
		"page-selector-current-page-bg" => "rgba(112,15,15,.35) !important"
	);
