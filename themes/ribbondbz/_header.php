...
include($prevFolder."themes/ribbondbz/ribbondbzmenu.php");
$themeMenusObj = new RibbonDBZMenu($mysqli);

$btThemeObj->setThemeName("Ribbon DBZ");

$btThemeObj->menusObj = $themeMenusObj;
$btThemeObj->updateHeadItem("jquery-ui-css", "<link rel='stylesheet' type='text/css' href='".MAIN_ROOT."themes/ribbondbz/jqueryui/jquery-ui-1.9.2.custom.min.css'>");
$btThemeObj->addHeadItem("google-font", "<link href='https://fonts.googleapis.com/css?family=Russo+One' rel='stylesheet' type='text/css'>");
