<?php
	...
	$THEME_COLOR = ($_SESSION['rcpThemeColor'] == "") ? "blue" : $_SESSION['rcpThemeColor'];
	...
	$arrCSSInfo = array(
		...
		"form-component-border" => "solid ".$arrRCPThemeColors[$THEME_COLOR]." 1px",
		...
		"default-border-color" => $arrRCPThemeColors[$THEME_COLOR],
		"box-bg-color" => "transparent",
		"box-bg-image" => "url('".$THEME."/images/theme/".$THEME_COLOR."/formdiv-bg.png')",
		...
		"table-title-bg-image" => "url('".$THEME."/images/theme/".$THEME_COLOR."/gradient.png')",
		"table-title-font-weight" => "bold",
		"table-title-font-color" => "white",
		"table-title-font-size" => "12px",
		"table-title-height" => "14px",
		"error-bg-color" => "url('".$THEME."/images/theme/".$THEME_COLOR."/formdiv-bg.png')",
		"error-border" => "dashed ".$arrRCPThemeColors[$THEME_COLOR]." 1px",
		...
		"alternate-bg-color" => "url('".$THEME."/images/theme/".$THEME_COLOR."/formdiv-bg.png')",
		...
		"forum-title-bg-image" => "url('".$THEME."/images/theme/".$THEME_COLOR."/gradient.png')",
		...
		"forum-quote-bg-image" => "url('".$THEME."/images/theme/".$THEME_COLOR."/formdiv-bg.png')",
		...
		"poll-info-label-bg" => "url('".$THEME."/images/theme/".$THEME_COLOR."/formdiv-bg.png')",
		"poll-profilepic-width" => "90px",
		"poll-profilepic-height" => "120px",
		"page-selector-current-page-bg" => "rgba(255,255,255,.25) !important"
	);
