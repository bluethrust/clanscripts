...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(2, 0, 'Top Players', 2, 'customcode', '<div class=''navMenuTitle''>Top Players</div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(14, 0, 'Forum Activity', 4, 'customcode', '<div class=''navMenuTitle''>Forum Activity</div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(16, 1, 'Login', 1, 'customcode', '<div class=''navMenuTitle''>Log In</div>', 2, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(12, 1, 'Logged In', 2, 'customcode', '<div class=''navMenuTitle''>Logged In</div>', 1, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(9, 1, 'Shoutbox', 3, 'customcode', '<div class=''navMenuTitle''>Shoutbox</div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(15, 1, 'New Members', 4, 'customcode', '<div class=''navMenuTitle''>Newest Members</div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(17, 0, 'Poll', 3, 'customcode', '<div class=''navMenuTitle''>Poll</div>', 0, 1);
