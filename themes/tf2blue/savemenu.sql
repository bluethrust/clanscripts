INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('3', '0', 'Main Menu', '1', 'customcode', '<div class=\'sideMenu_mainMenu\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('2', '0', 'Top Players', '2', 'customcode', '<div class=\'sideMenu_topPlayers\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('15', '0', 'Poll', '3', 'customcode', '<img src=\'[MAIN_ROOT]themes/tf2blue/images/layout/poll.png\' style=\'margin-bottom: 10px\'>', '0', '1');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('5', '0', 'Forum Activity', '4', 'customcode', '<div class=\'sideMenu_forumActivity\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('1', '1', 'Shoutbox', '1', 'customcode', '<div class=\'sideMenu_shoutBox\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('4', '1', 'Newest Members', '2', 'customcode', '<div class=\'sideMenu_newMembers\'></div>', '0', '0');
...
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('7', '46', 'code', '<a href=\'[MAIN_ROOT]news\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_News\'></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('8', '47', 'code', '<a href=\'[MAIN_ROOT]members.php\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_Members\'></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('9', '48', 'code', '<a href=\'[MAIN_ROOT]tournaments\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_Tournaments\'></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('10', '49', 'code', '<a href=\'[MAIN_ROOT]squads\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_Squads\'></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('11', '50', 'code', '<a href=\'[MAIN_ROOT]events\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_Events\'></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES ('12', '51', 'code', '<a href=\'[MAIN_ROOT]forum\'><img src=\'[MAIN_ROOT]themes/tf2blue/images/transparent.png\' class=\'topMenu_Forum\'></a>');
