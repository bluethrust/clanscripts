...
$menuSQL = "
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(1, 50, 'code', '<a href=''[MAIN_ROOT]news''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_News''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(2, 51, 'code', '<a href=''[MAIN_ROOT]members.php''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_Members''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(3, 52, 'code', '<a href=''[MAIN_ROOT]tournaments''><a href=''[MAIN_ROOT]tournaments''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_Tournaments''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(4, 53, 'code', '<a href=''[MAIN_ROOT]squads''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_Squads''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(5, 54, 'code', '<a href=''[MAIN_ROOT]events''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_Events''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(6, 55, 'code', '<a href=''[MAIN_ROOT]forum''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_Forum''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(7, 58, 'code', '<a href=''[MAIN_ROOT]signup.php''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_SignUp''></a>');
INSERT INTO `menuitem_customblock` (`menucustomblock_id`, `menuitem_id`, `blocktype`, `code`) VALUES(8, 59, 'code', '<a href=''[MAIN_ROOT]members''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topMenu_MyAccount''></a>');
...
INSERT INTO `menuitem_link` (`menulink_id`, `menuitem_id`, `link`, `linktarget`, `prefix`, `textalign`) VALUES(30, 60, 'inactive-members.php', '', '<b>&middot;</b> ', 'left');
...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(3, 0, 'Main Menu', 1, 'customcode', '<div class=''leftMenuTitleBG''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''mainMenuIMG''></div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(2, 0, 'Top Players', 2, 'customcode', '<div class=''leftMenuTitleBG''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''topPlayersMenuIMG''></div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(14, 0, 'Forum Activity', 4, 'customcode', '<div class=''leftMenuTitleBG''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''forumActivityMenuIMG''></div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(9, 1, 'Shoutbox', 1, 'customcode', '<div class=''rightMenuTitleBG''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''shoutboxMenuIMG''></div>', 0, 0);
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(15, 1, 'New Members', 2, 'customcode', '<div class=''rightMenuTitleBG''><img src=''[MAIN_ROOT]themes/battlecity/images/transparent.png'' class=''newMembersMenuIMG''></div>', 0, 0);
...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES(16, 0, 'Poll', 3, 'customcode', '<div class=''leftMenuTitleBG''>\r\n    <img src=''[MAIN_ROOT]themes/battlecity/images/layout/poll.png''>\r\n</div>', 0, 1);
...
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(58, 13, 'Sign Up', 'customcode', 7, 2, 0, 7);
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(59, 13, 'My Account', 'customcode', 8, 1, 0, 8);
INSERT INTO `menu_item` (`menuitem_id`, `menucategory_id`, `name`, `itemtype`, `itemtype_id`, `accesstype`, `hide`, `sortnum`) VALUES(60, 3, 'Inactive Members', 'link', 30, 0, 0, 14);
