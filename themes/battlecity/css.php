<?php
	...
	$arrCSSInfo = array(
		...
		"console-category-button-border" => "dotted #000000 1px",
		"console-category-button-bg-color" => "#4e4e4e",
		"console-category-button-hover-bg-color" => "#767676",
		...
		"error-bg-color" => "rgba(17,20,30,.25)",
		...
		"alternate-bg-color" => "rgba(17,20,30,.25)",
		"youtube-embed-width" => "560px",
		"youtube-embed-height" => "315px",
		"shoutbox-bg-color" => "rgba(17,20,30,.25)",
		"shoutbox-bg-image" => "none",
		"shoutbox-font-size" => "11px",
		"squad-logo-width" => "400px",
		"squad-logo-height" => "100px",
		"tournament-bracket-link-color" => "#ff7e00",
		"tournament-bracket-link-hover-color" => "#ffa651",
		...
		"forum-new-post-bg-image" => "rgba(17,20,30,.35)",
		"forum-quote-bg-color" => "rgba(17,20,30,.25)",
		...
		"page-selector-current-page-bg" => "rgba(17,20,30,.65) !important"
	);
