<?php
	...
	$arrCSSInfo = array(
		...
		"link-hover-color" => "rgba(255,255,255,.5)",
		"font-family" => "verdana, sans-serif",
		"dialog-font-color" => "white",
		"dialog-font-family" => "verdana, sans-serif",
		"form-component-border" => "solid rgba(93,93,93,.2) 1px",
		...
		"default-border-color" => "rgba(93,93,93,.5)",
		...
		"tournament-bracket-link-hover-color" => "rgba(255,255,255,.5)",
		...
		"forum-new-post-bg-color" => "rgba(255,255,255,.05)",
		...
		"page-selector-current-page-bg" => "rgba(93,93,93,.2) !important"
	);
