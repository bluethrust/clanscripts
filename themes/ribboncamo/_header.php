...
include($prevFolder."themes/ribboncamo/ribboncamomenu.php");
$themeMenusObj = new RibbonCamoMenu($mysqli);

$btThemeObj->setThemeName("Ribbon Camo");

$btThemeObj->menusObj = $themeMenusObj;
$btThemeObj->updateHeadItem("jquery-ui-css", "<link rel='stylesheet' type='text/css' href='".MAIN_ROOT."themes/ribboncamo/jqueryui/jquery-ui-1.9.2.custom.min.css'>");
$btThemeObj->addHeadItem("google-font", "<link href='https://fonts.googleapis.com/css?family=Titillium+Web' rel='stylesheet' type='text/css'>");
