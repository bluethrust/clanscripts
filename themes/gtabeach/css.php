<?php
	...
	$arrCSSInfo = array(
		...
		"console-category-button-bg-color" => "#c5c5c5",
		...
		"tournament-bracket-link-hover-color" => "#004260",
		...
		"page-selector-current-page-bg" => "rgba(0,0,0,.25) !important"
	);
