...
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('17', '0', 'Poll', '3', 'customcode', '<div style=\'text-align: center; margin-bottom: 8px; margin-top: 20px\'>\r\n    <img src=\'[MAIN_ROOT]themes/zombie/images/layout/poll.png\'>\r\n</div>', '0', '1');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('14', '0', 'Forum Activity', '4', 'customcode', '<div class=\'forumActivityIMG\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('16', '1', 'Login', '1', 'customcode', '<div class=\'loginIMG\'></div>', '2', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('12', '1', 'Logged In', '2', 'customcode', '<div class=\'loggedinIMG\'></div>', '1', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('9', '1', 'Shoutbox', '3', 'customcode', '<div class=\'shoutboxIMG\'></div>', '0', '0');
INSERT INTO `menu_category` (`menucategory_id`, `section`, `name`, `sortnum`, `headertype`, `headercode`, `accesstype`, `hide`) VALUES ('15', '1', 'New Members', '4', 'customcode', '<div class=\'newMembersIMG\'></div>', '0', '0');
