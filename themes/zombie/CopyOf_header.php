...
<html>
	<head>
		...
		<link rel='stylesheet' type='text/css' href='<?php echo $MAIN_ROOT; ?>themes/zombie/jqueryui/jquery-ui-1.9.2.custom.min.css'>
		...
		<link rel='stylesheet' type='text/css' href='<?php echo $MAIN_ROOT; ?>themes/zombie/btcs4.css'>
		<link rel='stylesheet' type='text/css' href='<?php echo $MAIN_ROOT; ?>themes/zombie/style.css'>
	...
	<body>
		...
		<div class='mainSiteDiv'>
			...
			<div class='logoDiv'><img src='<?php echo $MAIN_ROOT; ?>themes/zombie/images/logo.png'></div>
						...
						<table class='innerContentTable'>
							...
							<div class='main' style='margin-bottom: 15px'>
								<p align='center' style='margin: 0px; padding: 0px'>
									<span class='main' style='color: darkgray; font-weight: bold'>Eastern Time: <span id='showEasternTime'></span></span> || <span class='main' style='color: slategray; font-weight: bold'>Central Time: <span id='showCentralTime'></span></span> || <span class='main' style='color: lightslategray; font-weight: bold'>Mountain Time: <span id='showMountainTime'></span></span> || <span class='main' style='color: dimgray; font-weight: bold'>Pacific Time: <span id='showPacificTime'></span></span>
								</p>
							</div>
