...
while($row = $result->fetch_assoc()) {
	...
	elseif($newestMemberInfo['profilepic'] == "") {
		$newestMemberInfo['profilepic'] = $MAIN_ROOT."themes/zombie/images/defaultprofile.png";
	}
...
$arrSpecialMenuItems['forumactivity'] = "<div style='margin-left: 1px; margin-right: 1px; margin-top: 5px; margin-bottom: 20px'>";
$counter = 0;
$postCount = 0;
...
while($row = $result->fetch_assoc()) {
	...
	if($blnShowPost) {
		...
		elseif($forumMemberInfo['avatar'] == "") {
			$forumMemberInfo['avatar'] = $MAIN_ROOT."themes/zombie/images/defaultavatar.png";
		}
