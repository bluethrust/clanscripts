<?php
	...
	$arrTableColumns['events'][6] = "enddate";
	$arrTableColumns['events'][7] = "publicprivate";
	$arrTableColumns['events'][8] = "visibility";
	$arrTableColumns['events'][9] = "messages";
	$arrTableColumns['events'][10] = "invitepermission";
	...
	$arrTableColumns['members'][8] = "facebook";
	$arrTableColumns['members'][9] = "twitter";
	$arrTableColumns['members'][10] = "youtube";
	$arrTableColumns['members'][11] = "googleplus";
	$arrTableColumns['members'][12] = "twitch";
	$arrTableColumns['members'][13] = "maingame_id";
	$arrTableColumns['members'][14] = "birthday";
	$arrTableColumns['members'][15] = "datejoined";
	$arrTableColumns['members'][16] = "lastlogin";
	$arrTableColumns['members'][17] = "lastseen";
	$arrTableColumns['members'][18] = "lastseenlink";
	$arrTableColumns['members'][19] = "loggedin";
	$arrTableColumns['members'][20] = "lastpromotion";
	$arrTableColumns['members'][21] = "lastdemotion";
	$arrTableColumns['members'][22] = "timesloggedin";
	$arrTableColumns['members'][23] = "recruiter";
	$arrTableColumns['members'][24] = "ipaddress";
	$arrTableColumns['members'][25] = "profileviews";
	$arrTableColumns['members'][26] = "defaultconsole";
	$arrTableColumns['members'][27] = "disabled";
	$arrTableColumns['members'][28] = "disableddate";
	$arrTableColumns['members'][29] = "notifications";
	...
	$arrTableColumns['tournaments'][6] = "eliminations";
	$arrTableColumns['tournaments'][7] = "playersperteam";
	$arrTableColumns['tournaments'][8] = "maxteams";
	$arrTableColumns['tournaments'][9] = "status";
	$arrTableColumns['tournaments'][10] = "description";
	$arrTableColumns['tournaments'][11] = "password";
	$arrTableColumns['tournaments'][12] = "requirereplay";
	$arrTableColumns['tournaments'][13] = "access";
	...
	$arrTableColumns['websiteinfo'][1] = "clanname";
	$arrTableColumns['websiteinfo'][2] = "clantag";
	$arrTableColumns['websiteinfo'][3] = "preventhack";
	$arrTableColumns['websiteinfo'][4] = "maxdsl";
	$arrTableColumns['websiteinfo'][5] = "theme";
	$arrTableColumns['websiteinfo'][6] = "lowdsl";
	$arrTableColumns['websiteinfo'][7] = "meddsl";
	$arrTableColumns['websiteinfo'][8] = "highdsl";
	$arrTableColumns['websiteinfo'][9] = "logourl";
	$arrTableColumns['websiteinfo'][10] = "forumurl";
	$arrTableColumns['websiteinfo'][11] = "failedlogins";
	$arrTableColumns['websiteinfo'][12] = "maxdiplomacy";
	$arrTableColumns['websiteinfo'][13] = "mostonline";
	$arrTableColumns['websiteinfo'][14] = "mostonlinedate";
	$arrTableColumns['websiteinfo'][15] = "memberregistration";
	$arrTableColumns['websiteinfo'][16] = "memberapproval";
	$arrTableColumns['websiteinfo'][17] = "medalorder";
	$arrTableColumns['websiteinfo'][18] = "newsticker";
	$arrTableColumns['websiteinfo'][19] = "newstickercolor";
	$arrTableColumns['websiteinfo'][20] = "newstickersize";
	$arrTableColumns['websiteinfo'][21] = "newstickerbold";
	$arrTableColumns['websiteinfo'][22] = "newstickeritalic";
	$arrTableColumns['websiteinfo'][23] = "debugmode";
