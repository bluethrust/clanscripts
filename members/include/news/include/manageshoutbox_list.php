...
while($row = $result->fetch_assoc()) {
	...
	echo "
		<tr>
			...
			<td class='pmInbox main solidLine".$addCSS."' style='padding-left: 5px' width=\"35%\"><div style='width: 85%; white-space:nowrap; overflow: hidden; text-overflow: ellipsis'><a href='".$MAIN_ROOT."members/console.php?cID=".$manageNewsCID."&newsID=".$row['news_id']."'>".filterText($row['newspost'])."</a></div></td>
