...
$result = $mysqli->query("SELECT * FROM ".$dbprefix."forum_board");
...
if($totalBoards > 0) {
	...
	while($row = $result->fetch_assoc()) {
		...
		foreach($arrBoards as $boardID) {
			...
			$test = $boardObj->getHighestSortNum();
			...
			echo "
				<tr>
					<td class='dottedLine main".$addCSS."' style='width: 76%; padding-left: 10px'><b><a href='".$MAIN_ROOT."members/console.php?cID=".$cID."&bID=".$boardInfo['forumboard_id']."&action=edit'>".$boardInfo['name']."</a></b></td>
